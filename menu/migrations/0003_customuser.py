...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('menu', '0002_remove_product_description'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, verbose_name='Админ ҳуқуқи')),
                ('phone_number', models.CharField(blank=True, max_length=15, null=True, verbose_name='Телефон рақам')),
